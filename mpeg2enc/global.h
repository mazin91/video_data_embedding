...
/* putpic.c */
int putpict _ANSI_ARGS_((unsigned char *frame, char *msg));

/* putseq.c */
void putseq _ANSI_ARGS_((char *msg));
...
EXTERN FILE *outfile, *statfile, *inFile; /* file descriptors */
...
EXTERN char msg[1000000];
EXTERN int embedding;
EXTERN long int msg_len;
EXTERN long long int maximum_we_can_embed;

EXTERN long int embedded_bits;